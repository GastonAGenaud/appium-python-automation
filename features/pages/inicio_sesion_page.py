...
class InicioSesionPage(Page):
    ...
    vuelta_1 = (MobileBy.XPATH, '//android.view.ViewGroup[@content-desc="Vuelta 1, Transporte, 12345678, Zona de carga, 10, Clientes gestionados, 0/9"]')
    ...
    def opcion_vuelta_1_visible(self):
        ...
        opcion_vuelta_1 = self.find_element(self.vuelta_1).is_displayed()
        return opcion_vuelta_1
