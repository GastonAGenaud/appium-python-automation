...
class AnularPedidoPage(Page):
    ...
    def valido_motivos_anulacion(self, motivos):
        for motivo in motivos:
            motivo_element = (MobileBy.XPATH, f"//android.widget.TextView[@text='{motivo}']")
    ...
    def valido_boton_enviar_motivo(self):
        self.implicit_wait_visible(self.enviar_motivo_btn)
        return self.find_element(self.enviar_motivo_btn).is_displayed()

    def click_enviar_motivo_btn(self):
        self.click_on_element(self.enviar_motivo_btn)
    ...
    def valido_boton_comenzar_ruta(self):
        ...
        return self.find_element(self.comenzar_ruta_btn).is_displayed()
    ...
    def valido_pedido_retomar(self):
        self.implicit_wait_visible(self.pedido_retomar)
        return self.find_element(self.pedido_retomar).is_displayed()

    def valido_boton_ver_detalle(self):
        self.implicit_wait_visible(self.ver_detalle_btn)
        return self.find_element(self.ver_detalle_btn).is_displayed()

    def click_ver_detalle_btn(self):
        self.click_on_element(self.ver_detalle_btn)
