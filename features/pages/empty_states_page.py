...
class EmptyStatesPage(Page):
    ...
    producto_en_entregados = (MobileBy.XPATH, '//android.view.ViewGroup[@content-desc="El Deseo SPA, Avda Andres '
                                              'Bello 2447, Abierto, Cierra a las 19:30, Productos , 20 caj - 10 pac, '
